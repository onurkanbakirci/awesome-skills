                  ...
                  >
                    ...
                    <CardHeader className="pb-0 mb-2">
                      ...
                      {skill.tags.includes('official') ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium rounded bg-gray-50 text-gray-600 border border-gray-200 w-fit">
                          {getOwnerIcon(skill.owner) && (
